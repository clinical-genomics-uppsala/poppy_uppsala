...
rule results_report_xlsx:
    input:
        ...
        hotspot_vcf="snv_indels/bcbio_variation_recall_ensemble/{sample}_{type}.ensembled.vep_annotated.artifact_annotated.background_annotated.filter.somatic_hard.filter.somatic.include.hotspot.vcf.gz",
        hotspot_tbi="snv_indels/bcbio_variation_recall_ensemble/{sample}_{type}.ensembled.vep_annotated.artifact_annotated.background_annotated.filter.somatic_hard.filter.somatic.include.hotspot.vcf.gz.tbi",
        ...
        hotspotbed=config["bcftools_filter_include_region"]["hotspot"],
